...
int WINAPI WinMain(HINSTANCE inst, HINSTANCE previnst, LPSTR cmdline, int cmdshow) {
	return $System::launchwin(true, ::jdk$localedata$test::init, []($StringArray* args)->void {
...
int main(int argc, char** argv) {
	return $System::launch(argc, argv, true, ::jdk$localedata$test::init, []($StringArray* args)->void {
		$var(TestCases, testcases, $new(TestCases, args));
		testcases->runCases();
	});
}
