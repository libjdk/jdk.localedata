...
$MethodInfo _TimeZoneNames_lb_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_lb::*)()>(&TimeZoneNames_lb::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_lb_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_lb",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_lb_MethodInfo_
};

$Object* allocate$TimeZoneNames_lb($Class* clazz) {
	return $of($alloc(TimeZoneNames_lb));
}
...
$Class* TimeZoneNames_lb::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_lb, name, initialize, &_TimeZoneNames_lb_ClassInfo_, allocate$TimeZoneNames_lb);
	return class$;
}
