...
$MethodInfo _CurrencyNames_mer_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_mer::*)()>(&CurrencyNames_mer::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_mer_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_mer",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_mer_MethodInfo_
};

$Object* allocate$CurrencyNames_mer($Class* clazz) {
	return $of($alloc(CurrencyNames_mer));
}

void CurrencyNames_mer::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* CurrencyNames_mer::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			$of("aed"_s),
			$of("Dirham ya Falme cia Kiarabu"_s)
		}),
		$$new($ObjectArray, {
			$of("aoa"_s),
		...
		$$new($ObjectArray, {
			$of("zar"_s),
			$of("Randi ya Afrika ya Sauthi"_s)
		}),
		$$new($ObjectArray, {
			$of("zmk"_s),
...
CurrencyNames_mer::CurrencyNames_mer() {
}

$Class* CurrencyNames_mer::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_mer, name, initialize, &_CurrencyNames_mer_ClassInfo_, allocate$CurrencyNames_mer);
	return class$;
}

$Class* CurrencyNames_mer::class$ = nullptr;
