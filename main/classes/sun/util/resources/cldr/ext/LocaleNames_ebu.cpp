...
$MethodInfo _LocaleNames_ebu_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LocaleNames_ebu::*)()>(&LocaleNames_ebu::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _LocaleNames_ebu_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.LocaleNames_ebu",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_LocaleNames_ebu_MethodInfo_
};

$Object* allocate$LocaleNames_ebu($Class* clazz) {
	return $of($alloc(LocaleNames_ebu));
}

void LocaleNames_ebu::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* LocaleNames_ebu::getContents() {
...
LocaleNames_ebu::LocaleNames_ebu() {
}

$Class* LocaleNames_ebu::load$($String* name, bool initialize) {
	$loadClass(LocaleNames_ebu, name, initialize, &_LocaleNames_ebu_ClassInfo_, allocate$LocaleNames_ebu);
	return class$;
}

$Class* LocaleNames_ebu::class$ = nullptr;
