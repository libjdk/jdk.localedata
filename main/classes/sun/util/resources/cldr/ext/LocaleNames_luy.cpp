...
$MethodInfo _LocaleNames_luy_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LocaleNames_luy::*)()>(&LocaleNames_luy::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _LocaleNames_luy_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.LocaleNames_luy",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_LocaleNames_luy_MethodInfo_
};

$Object* allocate$LocaleNames_luy($Class* clazz) {
	return $of($alloc(LocaleNames_luy));
}

void LocaleNames_luy::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* LocaleNames_luy::getContents() {
...
LocaleNames_luy::LocaleNames_luy() {
}

$Class* LocaleNames_luy::load$($String* name, bool initialize) {
	$loadClass(LocaleNames_luy, name, initialize, &_LocaleNames_luy_ClassInfo_, allocate$LocaleNames_luy);
	return class$;
}

$Class* LocaleNames_luy::class$ = nullptr;
