...
$MethodInfo _TimeZoneNames_wo_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_wo::*)()>(&TimeZoneNames_wo::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_wo_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_wo",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_wo_MethodInfo_
};

$Object* allocate$TimeZoneNames_wo($Class* clazz) {
	return $of($alloc(TimeZoneNames_wo));
}

void TimeZoneNames_wo::init$() {
	$TimeZoneNamesBundle::init$();
}

$ObjectArray2* TimeZoneNames_wo::getContents() {
	$useLocalCurrentObjectStackCache();
	$var($StringArray, GMT, $new($StringArray, {
		"GMT (waxtu Greenwich)"_s,
		""_s,
		""_s,
		""_s,
		""_s,
...
TimeZoneNames_wo::TimeZoneNames_wo() {
}

$Class* TimeZoneNames_wo::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_wo, name, initialize, &_TimeZoneNames_wo_ClassInfo_, allocate$TimeZoneNames_wo);
	return class$;
}

$Class* TimeZoneNames_wo::class$ = nullptr;
