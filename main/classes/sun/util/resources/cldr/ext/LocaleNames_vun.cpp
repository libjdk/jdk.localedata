...
$MethodInfo _LocaleNames_vun_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LocaleNames_vun::*)()>(&LocaleNames_vun::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _LocaleNames_vun_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.LocaleNames_vun",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_LocaleNames_vun_MethodInfo_
};

$Object* allocate$LocaleNames_vun($Class* clazz) {
	return $of($alloc(LocaleNames_vun));
}

void LocaleNames_vun::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* LocaleNames_vun::getContents() {
...
LocaleNames_vun::LocaleNames_vun() {
}

$Class* LocaleNames_vun::load$($String* name, bool initialize) {
	$loadClass(LocaleNames_vun, name, initialize, &_LocaleNames_vun_ClassInfo_, allocate$LocaleNames_vun);
	return class$;
}

$Class* LocaleNames_vun::class$ = nullptr;
