...
$MethodInfo _CurrencyNames_shi_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_shi::*)()>(&CurrencyNames_shi::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_shi_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_shi",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_shi_MethodInfo_
};

$Object* allocate$CurrencyNames_shi($Class* clazz) {
	return $of($alloc(CurrencyNames_shi));
}

void CurrencyNames_shi::init$() {
...
$ObjectArray2* CurrencyNames_shi::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			$of("zwd"_s),
			$of(u"ⴰⴷⵓⵍⴰⵔ ⵏ ⵣⵉⵎⴱⴰⴱⵡⵉ"_s)
		})
	}));
	return data;
}

CurrencyNames_shi::CurrencyNames_shi() {
}

$Class* CurrencyNames_shi::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_shi, name, initialize, &_CurrencyNames_shi_ClassInfo_, allocate$CurrencyNames_shi);
	return class$;
}

$Class* CurrencyNames_shi::class$ = nullptr;
