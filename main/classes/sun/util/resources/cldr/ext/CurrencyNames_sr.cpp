...
$MethodInfo _CurrencyNames_sr_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_sr::*)()>(&CurrencyNames_sr::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_sr_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_sr",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_sr_MethodInfo_
};

$Object* allocate$CurrencyNames_sr($Class* clazz) {
	return $of($alloc(CurrencyNames_sr));
}

void CurrencyNames_sr::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* CurrencyNames_sr::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			$of("afa"_s),
			$of(u"\u0410\u0432\u0433\u0430\u043d\u0438\u0441\u0442\u0430\u043d\u0441\u043a\u0438 \u0430\u0432\u0433\u0430\u043d\u0438 (1927\u20132002)"_s)
		}),
		$$new($ObjectArray, {
			$of("afn"_s),
		...
		$$new($ObjectArray, {
			$of("amd"_s),
			$of(u"\u0408\u0435\u0440\u043c\u0435\u043d\u0441\u043a\u0438 \u0434\u0440\u0430\u043c"_s)
		}),
		$$new($ObjectArray, {
			$of("ang"_s),
			$of(u"\u0425\u043e\u043b\u0430\u043d\u0434\u0441\u043a\u043e\u0430\u043d\u0442\u0438\u043b\u0441\u043a\u0438 \u0433\u0443\u043b\u0434\u0435\u043d"_s)
		}),
		$$new($ObjectArray, {
			$of("aoa"_s),
		...
		$$new($ObjectArray, {
			$of("aor"_s),
			$of(u"\u0410\u043d\u0433\u043e\u043b\u0438\u0458\u0441\u043a\u0430 \u043a\u0432\u0430\u043d\u0437\u0430 \u0440\u0435\u0430\u0452\u0443\u0441\u0442\u0430\u0434\u043e (1995\u20131999)"_s)
		}),
		$$new($ObjectArray, {
			$of("ara"_s),
		...
		$$new($ObjectArray, {
			$of("bam"_s),
			$of(u"\u0411\u043e\u0441\u0430\u043d\u0441\u043a\u043e-\u0445\u0435\u0440\u0446\u0435\u0433\u043e\u0432\u0430\u0447\u043a\u0430 \u043a\u043e\u043d\u0432\u0435\u0440\u0442\u0438\u0431\u0438\u043b\u043d\u0430 \u043c\u0430\u0440\u043a\u0430"_s)
		}),
		$$new($ObjectArray, {
			$of("bbd"_s),
			$of(u"\u0411\u0430\u0440\u0431\u0430\u0434\u043e\u0448\u043a\u0438 \u0434\u043e\u043b\u0430\u0440"_s)
		}),
		$$new($ObjectArray, {
			$of("bdt"_s),
		...
		$$new($ObjectArray, {
			$of("fjd"_s),
			$of(u"\u0424\u0438\u045f\u0438\u0458\u0441\u043a\u0438 \u0434\u043e\u043b\u0430\u0440"_s)
		}),
		$$new($ObjectArray, {
			$of("fkp"_s),
			$of(u"\u0424\u043e\u043a\u043b\u0430\u043d\u0434\u0441\u043a\u0430 \u0444\u0443\u043d\u0442\u0430"_s)
		}),
		$$new($ObjectArray, {
			$of("frf"_s),
		...
		$$new($ObjectArray, {
			$of("mro"_s),
			$of(u"\u041c\u0430\u0443\u0440\u0438\u0442\u0430\u043d\u0438\u0458\u0441\u043a\u0430 o\u0433\u0438\u0458\u0430 (1973\u20132017)"_s)
		}),
		$$new($ObjectArray, {
			$of("mru"_s),
		...
		$$new($ObjectArray, {
			$of("rol"_s),
			$of(u"\u0420\u0443\u043c\u0443\u043d\u0441\u043a\u0438 \u043b\u0435\u0458 (1952\u20132006)"_s)
		}),
		$$new($ObjectArray, {
			$of("ron"_s),
		...
		$$new($ObjectArray, {
			$of("std"_s),
			$of(u"\u0421\u0430\u043e\u0442\u043e\u043c\u0441\u043a\u0430 \u0434\u043e\u0431\u0440\u0430 (1977\u20132017)"_s)
		}),
		$$new($ObjectArray, {
			$of("stn"_s),
			$of(u"\u0421\u0430\u043e\u0442\u043e\u043c\u0441\u043a\u0430 \u0434\u043e\u0431\u0440\u0430"_s)
		}),
		$$new($ObjectArray, {
			$of("sur"_s),
		...
		$$new($ObjectArray, {
			$of("vnn"_s),
			$of(u"\u0412\u0438\u0458\u0435\u0442\u043d\u0430\u043c\u0441\u043a\u0438 \u0434\u043e\u043d\u0433 (1978\u20131985)"_s)
		}),
		$$new($ObjectArray, {
			$of("vuv"_s),
		...
		$$new($ObjectArray, {
			$of("zwd"_s),
			$of(u"\u0417\u0438\u043c\u0431\u0430\u0431\u0432\u0435\u0430\u043d\u0441\u043a\u0438 \u0434\u043e\u043b\u0430\u0440 (1980\u20132008)"_s)
		}),
		$$new($ObjectArray, {
			$of("zwl"_s),
...
CurrencyNames_sr::CurrencyNames_sr() {
}

$Class* CurrencyNames_sr::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_sr, name, initialize, &_CurrencyNames_sr_ClassInfo_, allocate$CurrencyNames_sr);
	return class$;
}

$Class* CurrencyNames_sr::class$ = nullptr;
