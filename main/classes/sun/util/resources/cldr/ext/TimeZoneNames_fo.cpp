...
$MethodInfo _TimeZoneNames_fo_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_fo::*)()>(&TimeZoneNames_fo::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_fo_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_fo",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_fo_MethodInfo_
};

$Object* allocate$TimeZoneNames_fo($Class* clazz) {
	return $of($alloc(TimeZoneNames_fo));
}

void TimeZoneNames_fo::init$() {
...
TimeZoneNames_fo::TimeZoneNames_fo() {
}

$Class* TimeZoneNames_fo::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_fo, name, initialize, &_TimeZoneNames_fo_ClassInfo_, allocate$TimeZoneNames_fo);
	return class$;
}

$Class* TimeZoneNames_fo::class$ = nullptr;
