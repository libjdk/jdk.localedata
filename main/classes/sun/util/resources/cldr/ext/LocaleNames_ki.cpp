...
$MethodInfo _LocaleNames_ki_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LocaleNames_ki::*)()>(&LocaleNames_ki::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _LocaleNames_ki_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.LocaleNames_ki",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_LocaleNames_ki_MethodInfo_
};

$Object* allocate$LocaleNames_ki($Class* clazz) {
	return $of($alloc(LocaleNames_ki));
}

void LocaleNames_ki::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* LocaleNames_ki::getContents() {
...
LocaleNames_ki::LocaleNames_ki() {
}

$Class* LocaleNames_ki::load$($String* name, bool initialize) {
	$loadClass(LocaleNames_ki, name, initialize, &_LocaleNames_ki_ClassInfo_, allocate$LocaleNames_ki);
	return class$;
}

$Class* LocaleNames_ki::class$ = nullptr;
