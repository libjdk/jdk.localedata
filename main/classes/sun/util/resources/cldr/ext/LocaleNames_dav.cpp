...
$MethodInfo _LocaleNames_dav_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LocaleNames_dav::*)()>(&LocaleNames_dav::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _LocaleNames_dav_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.LocaleNames_dav",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_LocaleNames_dav_MethodInfo_
};

$Object* allocate$LocaleNames_dav($Class* clazz) {
	return $of($alloc(LocaleNames_dav));
}

void LocaleNames_dav::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* LocaleNames_dav::getContents() {
...
LocaleNames_dav::LocaleNames_dav() {
}

$Class* LocaleNames_dav::load$($String* name, bool initialize) {
	$loadClass(LocaleNames_dav, name, initialize, &_LocaleNames_dav_ClassInfo_, allocate$LocaleNames_dav);
	return class$;
}

$Class* LocaleNames_dav::class$ = nullptr;
