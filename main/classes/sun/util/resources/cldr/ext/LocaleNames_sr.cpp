...
$ObjectArray2* LocaleNames_sr::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			$of("003"_s),
			$of(u"Северноамерички континент"_s)
		}),
		$$new($ObjectArray, {
			$of("005"_s),
		...
		$$new($ObjectArray, {
			$of("019"_s),
			$of(u"Северна и Јужна Америка"_s)
		}),
		$$new($ObjectArray, {
			$of("021"_s),
		...
		$$new($ObjectArray, {
			$of("CC"_s),
			$of(u"Кокосова (Килингова) Острва"_s)
		}),
		$$new($ObjectArray, {
			$of("CD"_s),
		...
		$$new($ObjectArray, {
			$of("HK"_s),
			$of(u"САР Хонгконг (Кина)"_s)
		}),
		$$new($ObjectArray, {
			$of("HM"_s),
			$of(u"Острво Херд и Мекдоналдова острва"_s)
		}),
		$$new($ObjectArray, {
			$of("HN"_s),
			$of(u"Хондурас"_s)
		...
		$$new($ObjectArray, {
			$of("IO"_s),
			$of(u"Британска територија Индијског океана"_s)
		}),
		$$new($ObjectArray, {
			$of("IQ"_s),
			$of(u"Ирак"_s)
		...
		$$new($ObjectArray, {
			$of("MF"_s),
			$of(u"Свети Мартин (Француска)"_s)
		}),
		$$new($ObjectArray, {
			$of("MG"_s),
			$of(u"Мадагаскар"_s)
		...
		$$new($ObjectArray, {
			$of("QO"_s),
			$of(u"Океанија (удаљена острва)"_s)
		}),
		$$new($ObjectArray, {
			$of("RE"_s),
			$of(u"Реинион"_s)
		...
		$$new($ObjectArray, {
			$of("TL"_s),
			$of(u"Тимор-Лесте (Источни Тимор)"_s)
		}),
		$$new($ObjectArray, {
			$of("TM"_s),
		...
		$$new($ObjectArray, {
			$of("VI"_s),
			$of(u"Америчка Девичанска Острва"_s)
		}),
		$$new($ObjectArray, {
			$of("VN"_s),
			$of(u"Вијетнам"_s)
		...
		$$new($ObjectArray, {
			$of("crs"_s),
			$of(u"сејшелски креолски француски"_s)
		}),
		$$new($ObjectArray, {
			$of("csb"_s),
			$of(u"кашупски"_s)
		...
		$$new($ObjectArray, {
			$of("frc"_s),
			$of(u"кајунски француски"_s)
		}),
		$$new($ObjectArray, {
			$of("frm"_s),
			$of(u"средњефранцуски"_s)
		}),
		$$new($ObjectArray, {
			$of("fro"_s),
		...
		$$new($ObjectArray, {
			$of("frr"_s),
			$of(u"севернофризијски"_s)
		}),
		$$new($ObjectArray, {
			$of("frs"_s),
			$of(u"источнофризијски"_s)
		}),
		$$new($ObjectArray, {
			$of("fur"_s),
			$of(u"фриулски"_s)
		...
		$$new($ObjectArray, {
			$of("sam"_s),
			$of(u"самаријански арамејски"_s)
		}),
		$$new($ObjectArray, {
			$of("saq"_s),
			$of(u"самбуру"_s)
		...
		$$new($ObjectArray, {
			$of("zgh"_s),
			$of(u"стандардни марокански тамазигт"_s)
		}),
		$$new($ObjectArray, {
			$of("zun"_s),
			$of(u"зуни"_s)
		...
		$$new($ObjectArray, {
			$of("Hans"_s),
			$of(u"поједностављено кинеско писмо"_s)
		}),
		$$new($ObjectArray, {
			$of("Hant"_s),
			$of(u"традиционално кинеско писмо"_s)
		}),
		$$new($ObjectArray, {
			$of("Hebr"_s),
		...
		$$new($ObjectArray, {
			$of("Hrkt"_s),
			$of(u"јапанска слоговна писма"_s)
		}),
		$$new($ObjectArray, {
			$of("Hung"_s),
		...
		$$new($ObjectArray, {
			$of("de_AT"_s),
			$of(u"аустријски немачки"_s)
		}),
		$$new($ObjectArray, {
			$of("de_CH"_s),
			$of(u"швајцарски високи немачки"_s)
		}),
		$$new($ObjectArray, {
			$of("en_GB"_s),
			$of(u"енглески (Велика Британија)"_s)
		}),
		$$new($ObjectArray, {
			$of("en_US"_s),
			$of(u"енглески (Сједињене Америчке Државе)"_s)
		}),
		$$new($ObjectArray, {
			$of("es_ES"_s),
		...
		$$new($ObjectArray, {
			$of("ar_001"_s),
			$of(u"савремени стандардни арапски"_s)
		}),
		$$new($ObjectArray, {
			$of("key.ca"_s),
			$of(u"календар"_s)
		...
		$$new($ObjectArray, {
			$of("key.hc"_s),
			$of(u"приказивање времена (12- или 24-часовно)"_s)
		}),
		$$new($ObjectArray, {
			$of("key.lb"_s),
			$of(u"стил прелома реда"_s)
		}),
		$$new($ObjectArray, {
			$of("key.ms"_s),
			$of(u"систем мерних јединица"_s)
		}),
		$$new($ObjectArray, {
			$of("key.nu"_s),
			$of(u"бројеви"_s)
		...
		$$new($ObjectArray, {
			$of("key.va"_s),
			$of(u"Варијанта локалитета"_s)
		}),
		$$new($ObjectArray, {
			$of("nds_NL"_s),
			$of(u"нискосаксонски"_s)
		}),
		$$new($ObjectArray, {
			$of("%%BISKE"_s),
		...
		$$new($ObjectArray, {
			$of("zh_Hans"_s),
			$of(u"поједностављени кинески"_s)
		}),
		$$new($ObjectArray, {
			$of("zh_Hant"_s),
			$of(u"традиционални кинески"_s)
		}),
		$$new($ObjectArray, {
			$of("%%FONIPA"_s),
		...
		$$new($ObjectArray, {
			$of("type.co.eor"_s),
			$of(u"европска правила редоследа"_s)
		}),
		$$new($ObjectArray, {
			$of("type.hc.h11"_s),
			$of(u"12-часовни систем (0-11)"_s)
		}),
		$$new($ObjectArray, {
			$of("type.hc.h12"_s),
			$of(u"12-часовни систем (1-12)"_s)
		}),
		$$new($ObjectArray, {
			$of("type.hc.h23"_s),
			$of(u"24-часовни систем (0-23)"_s)
		}),
		$$new($ObjectArray, {
			$of("type.hc.h24"_s),
			$of(u"24-часовни систем (1-24)"_s)
		}),
		$$new($ObjectArray, {
			$of("type.m0.bgn"_s),
			$of(u"БГН (BGN)"_s)
		...
		$$new($ObjectArray, {
			$of("type.co.ducet"_s),
			$of(u"подразумевани Unicode редослед сортирања"_s)
		}),
		$$new($ObjectArray, {
			$of("type.lb.loose"_s),
			$of(u"размакнути стил прелома реда"_s)
		}),
		$$new($ObjectArray, {
			$of("type.nu.roman"_s),
		...
		$$new($ObjectArray, {
			...
			$of(u"претходни редослед сортирања, због компатибилности"_s)
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			$of(u"нормални стил прелома реда"_s)
		}),
		$$new($ObjectArray, {
			$of("type.lb.strict"_s),
			$of(u"строги стил прелома реда"_s)
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			$of(u"Фонетски редослед сортирања"_s)
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			$of(u"Претрага према хангул почетном сугласнику"_s)
		}),
		$$new($ObjectArray, {
			$of("type.co.standard"_s),
			$of(u"стандардни редослед сортирања"_s)
		}),
		$$new($ObjectArray, {
