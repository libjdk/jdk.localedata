...
$MethodInfo _TimeZoneNames_sv_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_sv::*)()>(&TimeZoneNames_sv::init$))},
...
$ObjectArray2* TimeZoneNames_sv::getContents() {
	...
	$var($StringArray, Acre, $new($StringArray, {
		u"v\u00e4stbrasiliansk normaltid"_s,
		""_s,
		u"v\u00e4stbrasiliansk sommartid"_s,
		""_s,
		u"v\u00e4stbrasiliansk tid"_s,
		""_s
	}));
	...
	$var($StringArray, Cook, $new($StringArray, {
		u"Cook\u00f6arnas normaltid"_s,
		""_s,
		u"Cook\u00f6arnas sommartid"_s,
		""_s,
		u"Cook\u00f6arnas tid"_s,
		""_s
	}));
	...
	$var($StringArray, Azores, $new($StringArray, {
		"azorisk normaltid"_s,
		""_s,
		"azorisk sommartid"_s,
		""_s,
		"azorisk tid"_s,
		""_s
	}));
	...
	$var($StringArray, Israel, $new($StringArray, {
		"israelisk normaltid"_s,
		""_s,
		"israelisk sommartid"_s,
		""_s,
		"israelisk tid"_s,
		""_s
	}));
	...
	$var($StringArray, Wallis, $new($StringArray, {
		u"Wallis- och Futuna\u00f6arnas tid"_s,
		""_s,
		""_s,
		""_s,
		""_s,
	...
	$var($StringArray, Arabian, $new($StringArray, {
		"saudiarabisk normaltid"_s,
		""_s,
		"saudiarabisk sommartid"_s,
		""_s,
		"saudiarabisk tid"_s,
		""_s
	}));
	$var($StringArray, Armenia, $new($StringArray, {
		"armenisk normaltid"_s,
		""_s,
		"armenisk sommartid"_s,
		""_s,
		"armenisk tid"_s,
		""_s
	}));
	...
	$var($StringArray, Norfolk, $new($StringArray, {
		u"Norfolk\u00f6ns, normaltid"_s,
		""_s,
		u"Norfolk\u00f6ns, sommartid"_s,
		""_s,
		u"Norfolk\u00f6ns tid"_s,
		""_s
	}));
	...
	$var($StringArray, Atlantic, $new($StringArray, {
		"nordamerikansk atlantnormaltid"_s,
		""_s,
		"nordamerikansk atlantsommartid"_s,
		""_s,
		"nordamerikansk atlanttid"_s,
		""_s
	}));
	$var($StringArray, Brasilia, $new($StringArray, {
		"Brasilia, normaltid"_s,
		""_s,
		"Brasilia, sommartid"_s,
		""_s,
		"Brasiliatid"_s,
		""_s
	}));
	...
	$var($StringArray, Sakhalin, $new($StringArray, {
		"Sachalin, normaltid"_s,
		""_s,
		"Sachalin, sommartid"_s,
		""_s,
		"Sachalintid"_s,
		""_s
	}));
	...
	$var($StringArray, Argentina, $new($StringArray, {
		u"\u00f6stargentinsk normaltid"_s,
		""_s,
		u"\u00f6stargentinsk sommartid"_s,
		""_s,
		u"\u00f6stargentinsk tid"_s,
		""_s
	}));
	...
	$var($StringArray, Kamchatka, $new($StringArray, {
		"Kamtjatkanormaltid"_s,
		""_s,
		"Kamtjatkasommartid"_s,
		""_s,
		"Kamtjatkatid"_s,
		""_s
	}));
	...
	$var($StringArray, Volgograd, $new($StringArray, {
		...
		""_s,
		"Volgograd, sommartid"_s,
		""_s,
		"Volgogradtid"_s,
		""_s
	}));
	$var($StringArray, Azerbaijan, $new($StringArray, {
		"azerbajdzjansk normaltid"_s,
		""_s,
		"azerbajdzjansk sommartid"_s,
		""_s,
	...
	$var($StringArray, Uzbekistan, $new($StringArray, {
		"uzbekisk normaltid"_s,
		""_s,
		"uzbekisk sommartid"_s,
		""_s,
		"uzbekisk tid"_s,
		""_s
	}));
	...
	$var($StringArray, New_Zealand, $new($StringArray, {
		u"nyzeel\u00e4ndsk normaltid"_s,
		""_s,
		u"nyzeel\u00e4ndsk sommartid"_s,
		""_s,
	...
	$var($StringArray, Indian_Ocean, $new($StringArray, {
		u"Brittiska Indiska ocean\u00f6arnas tid"_s,
		""_s,
		""_s,
		""_s,
		""_s,
	...
	$var($StringArray, New_Caledonia, $new($StringArray, {
		"Nya Kaledonien, normaltid"_s,
		""_s,
		"Nya Kaledonien, sommartid"_s,
		""_s,
		"Nya Kaledonientid"_s,
		""_s
	}));
	...
	$var($StringArray, Mexico_Pacific, $new($StringArray, {
		"mexikansk stillahavstid, normaltid"_s,
		""_s,
		"mexikansk stillahavstid, sommartid"_s,
		""_s,
		"mexikansk stillahavstid"_s,
		""_s
	}));
	...
	$var($StringArray, America_Central, $new($StringArray, {
		"centralnordamerikansk normaltid"_s,
		""_s,
		"centralnordamerikansk sommartid"_s,
		""_s,
		"centralnordamerikansk tid"_s,
		""_s
	}));
	$var($StringArray, America_Eastern, $new($StringArray, {
		u"\u00f6stnordamerikansk normaltid"_s,
		""_s,
		u"\u00f6stnordamerikansk sommartid"_s,
		""_s,
		u"\u00f6stnordamerikansk tid"_s,
		""_s
	}));
	$var($StringArray, America_Pacific, $new($StringArray, {
		u"v\u00e4stnordamerikansk normaltid"_s,
		""_s,
		u"v\u00e4stnordamerikansk sommartid"_s,
		""_s,
		u"v\u00e4stnordamerikansk tid"_s,
		""_s
	}));
	$var($StringArray, French_Southern, $new($StringArray, {
		"Franska Sydterritoriernas tid"_s,
		""_s,
		""_s,
		""_s,
		""_s,
	...
	$var($StringArray, Hawaii_Aleutian, $new($StringArray, {
		"Honolulu, normaltid"_s,
		""_s,
		"Honolulu, sommartid"_s,
		""_s,
		"Honolulutid"_s,
		""_s
	}));
	...
	$var($StringArray, Pierre_Miquelon, $new($StringArray, {
		"S:t Pierre och Miquelon, normaltid"_s,
		""_s,
		"S:t Pierre och Miquelon, sommartid"_s,
		""_s,
		"S:t Pierre och Miquelontid"_s,
		""_s
	}));
	$var($StringArray, America_Mountain, $new($StringArray, {
		"Klippiga bergen, normaltid"_s,
		""_s,
		"Klippiga bergen, sommartid"_s,
		""_s,
		"Klippiga bergentid"_s,
		""_s
	}));
	$var($StringArray, Marshall_Islands, $new($StringArray, {
		u"Marshall\u00f6arnas tid"_s,
		""_s,
		""_s,
		""_s,
		""_s,
	...
	$var($StringArray, Mexico_Northwest, $new($StringArray, {
		u"nordv\u00e4stmexikansk normaltid"_s,
		""_s,
		u"nordv\u00e4stmexikansk sommartid"_s,
		""_s,
		u"nordv\u00e4stmexikansk tid"_s,
		""_s
	}));
	$var($StringArray, Papua_New_Guinea, $new($StringArray, {
		"Papua Nya Guineas tid"_s,
		""_s,
		""_s,
		""_s,
		""_s,
	...
	$var($StringArray, Australia_Central, $new($StringArray, {
		"centralaustralisk normaltid"_s,
		""_s,
		"centralaustralisk sommartid"_s,
		""_s,
		"centralaustralisk tid"_s,
		""_s
	}));
	$var($StringArray, Australia_Eastern, $new($StringArray, {
		u"\u00f6staustralisk normaltid"_s,
		""_s,
		u"\u00f6staustralisk sommartid"_s,
		""_s,
		u"\u00f6staustralisk tid"_s,
		""_s
	}));
	$var($StringArray, Australia_Western, $new($StringArray, {
		u"v\u00e4staustralisk normaltid"_s,
		""_s,
		u"v\u00e4staustralisk sommartid"_s,
		""_s,
		u"v\u00e4staustralisk tid"_s,
		""_s
	}));
	$var($StringArray, Greenland_Eastern, $new($StringArray, {
		u"\u00f6stgr\u00f6nl\u00e4ndsk normaltid"_s,
		""_s,
	...
	$var($StringArray, Greenland_Western, $new($StringArray, {
		u"v\u00e4stgr\u00f6nl\u00e4ndsk normaltid"_s,
		""_s,
		u"v\u00e4stgr\u00f6nl\u00e4ndsk sommartid"_s,
		""_s,
	...
	$var($StringArray, Australia_CentralWestern, $new($StringArray, {
		u"v\u00e4stcentralaustralisk normaltid"_s,
		""_s,
		u"v\u00e4stcentralaustralisk sommartid"_s,
		""_s,
		u"v\u00e4stcentralaustralisk tid"_s,
		""_s
	}));
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			$of($$new($StringArray, {
				"Honolulu, normaltid"_s,
				"Honolulunormaltid"_s,
				"Honolulu, sommartid"_s,
				"Honolulusommartid"_s,
				"Honolulutid"_s,
				"Honolulutid"_s
			}))
		}),
