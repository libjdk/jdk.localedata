...
$MethodInfo _CurrencyNames_rwk_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_rwk::*)()>(&CurrencyNames_rwk::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_rwk_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_rwk",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_rwk_MethodInfo_
};

$Object* allocate$CurrencyNames_rwk($Class* clazz) {
	return $of($alloc(CurrencyNames_rwk));
}

void CurrencyNames_rwk::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* CurrencyNames_rwk::getContents() {
...
CurrencyNames_rwk::CurrencyNames_rwk() {
}

$Class* CurrencyNames_rwk::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_rwk, name, initialize, &_CurrencyNames_rwk_ClassInfo_, allocate$CurrencyNames_rwk);
	return class$;
}

$Class* CurrencyNames_rwk::class$ = nullptr;
