...
$MethodInfo _LocaleNames_zgh_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LocaleNames_zgh::*)()>(&LocaleNames_zgh::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _LocaleNames_zgh_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.LocaleNames_zgh",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_LocaleNames_zgh_MethodInfo_
};

$Object* allocate$LocaleNames_zgh($Class* clazz) {
	return $of($alloc(LocaleNames_zgh));
}

void LocaleNames_zgh::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* LocaleNames_zgh::getContents() {
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			$of(u"\u2d30\u2d59\u2d4e\u2d4d\u2d53\u2d59\u2d59\u2d30\u2d4f \u2d4f \u2d49\u2d5c\u2d62\u2d53\u2d31\u2d62\u2d30"_s)
		}),
		$$new($ObjectArray, {
			$of("type.ca.gregorian"_s),
			$of(u"\u2d30\u2d59\u2d4e\u2d4d\u2d53\u2d59\u2d59\u2d30\u2d4f \u2d30\u2d33\u2d54\u2d49\u2d33\u2d53\u2d54"_s)
		})
	}));
	return data;
}

LocaleNames_zgh::LocaleNames_zgh() {
}

$Class* LocaleNames_zgh::load$($String* name, bool initialize) {
	$loadClass(LocaleNames_zgh, name, initialize, &_LocaleNames_zgh_ClassInfo_, allocate$LocaleNames_zgh);
	return class$;
}

$Class* LocaleNames_zgh::class$ = nullptr;
