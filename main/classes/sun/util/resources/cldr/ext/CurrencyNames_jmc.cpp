...
$MethodInfo _CurrencyNames_jmc_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_jmc::*)()>(&CurrencyNames_jmc::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_jmc_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_jmc",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_jmc_MethodInfo_
};

$Object* allocate$CurrencyNames_jmc($Class* clazz) {
	return $of($alloc(CurrencyNames_jmc));
}

void CurrencyNames_jmc::init$() {
...
CurrencyNames_jmc::CurrencyNames_jmc() {
}

$Class* CurrencyNames_jmc::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_jmc, name, initialize, &_CurrencyNames_jmc_ClassInfo_, allocate$CurrencyNames_jmc);
	return class$;
}

$Class* CurrencyNames_jmc::class$ = nullptr;
