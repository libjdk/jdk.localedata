...
$MethodInfo _TimeZoneNames_to_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_to::*)()>(&TimeZoneNames_to::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_to_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_to",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_to_MethodInfo_
};

$Object* allocate$TimeZoneNames_to($Class* clazz) {
	return $of($alloc(TimeZoneNames_to));
}

void TimeZoneNames_to::init$() {
...
$ObjectArray2* TimeZoneNames_to::getContents() {
	...
	$var($StringArray, Apia, $new($StringArray, {
		"houa fakaapia taimi totonu"_s,
		""_s,
		"houa fakaapia taimi liliu"_s,
		""_s,
		"houa fakaapia"_s,
		""_s
	}));
	...
	$var($StringArray, Cuba, $new($StringArray, {
		"houa fakakiupa taimi totonu"_s,
		""_s,
		"houa fakakiupa taimi liliu"_s,
		""_s,
		"houa fakakiupa"_s,
		""_s
	}));
	$var($StringArray, Fiji, $new($StringArray, {
		"houa fakafisi taimi totonu"_s,
		""_s,
		"houa fakafisi taimi liliu"_s,
		""_s,
		"houa fakafisi"_s,
		""_s
	}));
	...
	$var($StringArray, Hovd, $new($StringArray, {
		"houa fakahovite taimi totonu"_s,
		""_s,
		"houa fakahovite taimi liliu"_s,
		""_s,
		"houa fakahovite"_s,
		""_s
	}));
	...
	$var($StringArray, Chile, $new($StringArray, {
		"houa fakasili taimi totonu"_s,
		""_s,
		"houa fakasili taimi liliu"_s,
		""_s,
		"houa fakasili"_s,
		""_s
	}));
	$var($StringArray, China, $new($StringArray, {
		"houa fakasiaina taimi totonu"_s,
		""_s,
		"houa fakasiaina taimi liliu"_s,
		""_s,
		"houa fakasiaina"_s,
		""_s
	}));
	$var($StringArray, Cocos, $new($StringArray, {
		"houa fakamotukokosi"_s,
		""_s,
		""_s,
		""_s,
		""_s,
	...
	$var($StringArray, Japan, $new($StringArray, {
		"houa fakasiapani taimi totonu"_s,
		""_s,
		"houa fakasiapani taimi liliu"_s,
		""_s,
		"houa fakasiapani"_s,
		""_s
	}));
	...
	$var($StringArray, Tonga, $new($StringArray, {
		"houa fakatonga taimi totonu"_s,
		""_s,
		"houa fakatonga taimi liliu"_s,
		""_s,
		"houa fakatonga"_s,
		""_s
	}));
	...
	$var($StringArray, Easter, $new($StringArray, {
		"houa fakalapanui taimi totonu"_s,
		""_s,
		"houa fakalapanui taimi liliu"_s,
		""_s,
		"houa fakalapanui"_s,
		""_s
	}));
	...
	$var($StringArray, Taipei, $new($StringArray, {
		"houa fakataipei taimi totonu"_s,
		""_s,
		"houa fakataipei taimi liliu"_s,
		""_s,
		"houa fakataipei"_s,
		""_s
	}));
	...
	$var($StringArray, Chatham, $new($StringArray, {
		"houa fakasatihami taimi totonu"_s,
		""_s,
		"houa fakasatihami taimi liliu"_s,
		""_s,
		"houa fakasatihami"_s,
		""_s
	}));
	...
	$var($StringArray, Vanuatu, $new($StringArray, {
		"houa fakavanuatu taimi totonu"_s,
		""_s,
		"houa fakavanuatu taimi liliu"_s,
		""_s,
		"houa fakavanuatu"_s,
		""_s
	}));
	...
	$var($StringArray, Colombia, $new($StringArray, {
		"houa fakakolomipia taimi totonu"_s,
		""_s,
		"houa fakakolomipia taimi liliu"_s,
		""_s,
		"houa fakakolomipia"_s,
		""_s
	}));
	...
	$var($StringArray, Paraguay, $new($StringArray, {
		"houa fakapalakuai taimi totonu"_s,
		""_s,
		"houa fakapalakuai taimi liliu"_s,
		""_s,
		"houa fakapalakuai"_s,
		""_s
	}));
	$var($StringArray, Pitcairn, $new($StringArray, {
		"houa fakapitikani"_s,
		""_s,
		""_s,
		""_s,
		""_s,
	...
	$var($StringArray, Hong_Kong, $new($StringArray, {
		"houa fakahongi-kongi taimi totonu"_s,
		""_s,
		"houa fakahongi-kongi taimi liliu"_s,
		""_s,
		"houa fakahongi-kongi"_s,
		""_s
	}));
	...
	$var($StringArray, Mauritius, $new($StringArray, {
		"houa fakamaulitiusi taimi totonu"_s,
		""_s,
		"houa fakamaulitiusi taimi liliu"_s,
		""_s,
		"houa fakamaulitiusi"_s,
		""_s
	}));
	$var($StringArray, Singapore, $new($StringArray, {
		"houa fakasingapoa"_s,
		""_s,
		""_s,
		""_s,
		""_s,
	...
	$var($StringArray, Philippines, $new($StringArray, {
		"houa fakafilipaine taimi totonu"_s,
		""_s,
		"houa fakafilipaine taimi liliu"_s,
		""_s,
		"houa fakafilipaine"_s,
		""_s
	}));
	...
	$var($StringArray, Mexico_Pacific, $new($StringArray, {
		"houa fakamekisikou-pasifika taimi totonu"_s,
		""_s,
		"houa fakamekisikou-pasifika taimi liliu"_s,
		""_s,
		"houa fakamekisikou-pasifika"_s,
		""_s
	}));
	...
	$var($StringArray, Mexico_Northwest, $new($StringArray, {
		"houa fakamekisikou-tokelauhihifo taimi totonu"_s,
		""_s,
		"houa fakamekisikou-tokelauhihifo taimi liliu"_s,
		""_s,
		"houa fakamekisikou-tokelauhihifo"_s,
		""_s
	}));
	$var($StringArray, Papua_New_Guinea, $new($StringArray, {
		"houa fakapapuaniukini"_s,
		""_s,
		""_s,
		""_s,
		""_s,
	...
	$var($StringArray, Greenland_Eastern, $new($StringArray, {
		"houa fakafonuamata-hahake taimi totonu"_s,
		""_s,
		"houa fakafonuamata-hahake taimi liliu"_s,
		""_s,
		"houa fakafonuamata-hahake"_s,
		""_s
	}));
	$var($StringArray, Greenland_Western, $new($StringArray, {
		"houa fakafonuamata-hihifo taimi totonu"_s,
		""_s,
		"houa fakafonuamata-hihifo taimi liliu"_s,
		""_s,
		"houa fakafonuamata-hihifo"_s,
		""_s
	}));
...
TimeZoneNames_to::TimeZoneNames_to() {
}

$Class* TimeZoneNames_to::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_to, name, initialize, &_TimeZoneNames_to_ClassInfo_, allocate$TimeZoneNames_to);
	return class$;
}

$Class* TimeZoneNames_to::class$ = nullptr;
