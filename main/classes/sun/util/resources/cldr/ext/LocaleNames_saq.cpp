...
$MethodInfo _LocaleNames_saq_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LocaleNames_saq::*)()>(&LocaleNames_saq::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _LocaleNames_saq_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.LocaleNames_saq",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_LocaleNames_saq_MethodInfo_
};

$Object* allocate$LocaleNames_saq($Class* clazz) {
	return $of($alloc(LocaleNames_saq));
}

void LocaleNames_saq::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* LocaleNames_saq::getContents() {
...
LocaleNames_saq::LocaleNames_saq() {
}

$Class* LocaleNames_saq::load$($String* name, bool initialize) {
	$loadClass(LocaleNames_saq, name, initialize, &_LocaleNames_saq_ClassInfo_, allocate$LocaleNames_saq);
	return class$;
}

$Class* LocaleNames_saq::class$ = nullptr;
