...
$MethodInfo _CurrencyNames_ses_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_ses::*)()>(&CurrencyNames_ses::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_ses_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_ses",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_ses_MethodInfo_
};

$Object* allocate$CurrencyNames_ses($Class* clazz) {
	return $of($alloc(CurrencyNames_ses));
}

void CurrencyNames_ses::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* CurrencyNames_ses::getContents() {
...
CurrencyNames_ses::CurrencyNames_ses() {
}

$Class* CurrencyNames_ses::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_ses, name, initialize, &_CurrencyNames_ses_ClassInfo_, allocate$CurrencyNames_ses);
	return class$;
}

$Class* CurrencyNames_ses::class$ = nullptr;
