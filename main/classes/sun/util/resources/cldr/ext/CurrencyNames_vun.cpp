...
$MethodInfo _CurrencyNames_vun_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_vun::*)()>(&CurrencyNames_vun::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_vun_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_vun",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_vun_MethodInfo_
};

$Object* allocate$CurrencyNames_vun($Class* clazz) {
	return $of($alloc(CurrencyNames_vun));
}

void CurrencyNames_vun::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* CurrencyNames_vun::getContents() {
...
CurrencyNames_vun::CurrencyNames_vun() {
}

$Class* CurrencyNames_vun::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_vun, name, initialize, &_CurrencyNames_vun_ClassInfo_, allocate$CurrencyNames_vun);
	return class$;
}

$Class* CurrencyNames_vun::class$ = nullptr;
