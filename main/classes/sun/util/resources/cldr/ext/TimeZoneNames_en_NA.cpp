...
$MethodInfo _TimeZoneNames_en_NA_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_en_NA::*)()>(&TimeZoneNames_en_NA::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_en_NA_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_en_NA",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_en_NA_MethodInfo_
};

$Object* allocate$TimeZoneNames_en_NA($Class* clazz) {
	return $of($alloc(TimeZoneNames_en_NA));
}
...
$Class* TimeZoneNames_en_NA::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_en_NA, name, initialize, &_TimeZoneNames_en_NA_ClassInfo_, allocate$TimeZoneNames_en_NA);
	return class$;
}
