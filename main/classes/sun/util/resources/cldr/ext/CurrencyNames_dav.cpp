...
$MethodInfo _CurrencyNames_dav_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_dav::*)()>(&CurrencyNames_dav::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_dav_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_dav",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_dav_MethodInfo_
};

$Object* allocate$CurrencyNames_dav($Class* clazz) {
	return $of($alloc(CurrencyNames_dav));
}

void CurrencyNames_dav::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* CurrencyNames_dav::getContents() {
...
CurrencyNames_dav::CurrencyNames_dav() {
}

$Class* CurrencyNames_dav::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_dav, name, initialize, &_CurrencyNames_dav_ClassInfo_, allocate$CurrencyNames_dav);
	return class$;
}

$Class* CurrencyNames_dav::class$ = nullptr;
