...
$MethodInfo _TimeZoneNames_doi_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_doi::*)()>(&TimeZoneNames_doi::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_doi_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_doi",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_doi_MethodInfo_
};

$Object* allocate$TimeZoneNames_doi($Class* clazz) {
	return $of($alloc(TimeZoneNames_doi));
}

void TimeZoneNames_doi::init$() {
...
TimeZoneNames_doi::TimeZoneNames_doi() {
}

$Class* TimeZoneNames_doi::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_doi, name, initialize, &_TimeZoneNames_doi_ClassInfo_, allocate$TimeZoneNames_doi);
	return class$;
}

$Class* TimeZoneNames_doi::class$ = nullptr;
