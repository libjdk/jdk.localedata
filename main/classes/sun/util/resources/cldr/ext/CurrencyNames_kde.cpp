...
$MethodInfo _CurrencyNames_kde_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_kde::*)()>(&CurrencyNames_kde::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_kde_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_kde",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_kde_MethodInfo_
};

$Object* allocate$CurrencyNames_kde($Class* clazz) {
	return $of($alloc(CurrencyNames_kde));
}

void CurrencyNames_kde::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* CurrencyNames_kde::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			$of("aed"_s),
			$of("Dirham ya Falme za Chiarabu"_s)
		}),
		$$new($ObjectArray, {
			$of("aoa"_s),
...
CurrencyNames_kde::CurrencyNames_kde() {
}

$Class* CurrencyNames_kde::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_kde, name, initialize, &_CurrencyNames_kde_ClassInfo_, allocate$CurrencyNames_kde);
	return class$;
}

$Class* CurrencyNames_kde::class$ = nullptr;
