...
$MethodInfo _LocaleNames_es_SV_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LocaleNames_es_SV::*)()>(&LocaleNames_es_SV::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _LocaleNames_es_SV_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.LocaleNames_es_SV",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_LocaleNames_es_SV_MethodInfo_
};

$Object* allocate$LocaleNames_es_SV($Class* clazz) {
	return $of($alloc(LocaleNames_es_SV));
}
...
$Class* LocaleNames_es_SV::load$($String* name, bool initialize) {
	$loadClass(LocaleNames_es_SV, name, initialize, &_LocaleNames_es_SV_ClassInfo_, allocate$LocaleNames_es_SV);
	return class$;
}
