...
$MethodInfo _TimeZoneNames_mai_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_mai::*)()>(&TimeZoneNames_mai::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_mai_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_mai",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_mai_MethodInfo_
};

$Object* allocate$TimeZoneNames_mai($Class* clazz) {
	return $of($alloc(TimeZoneNames_mai));
}

void TimeZoneNames_mai::init$() {
	$TimeZoneNamesBundle::init$();
}

$ObjectArray2* TimeZoneNames_mai::getContents() {
...
TimeZoneNames_mai::TimeZoneNames_mai() {
}

$Class* TimeZoneNames_mai::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_mai, name, initialize, &_TimeZoneNames_mai_ClassInfo_, allocate$TimeZoneNames_mai);
	return class$;
}

$Class* TimeZoneNames_mai::class$ = nullptr;
