...
$MethodInfo _TimeZoneNames_cs_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_cs::*)()>(&TimeZoneNames_cs::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_cs_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_cs",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_cs_MethodInfo_
};

$Object* allocate$TimeZoneNames_cs($Class* clazz) {
	return $of($alloc(TimeZoneNames_cs));
}
...
$ObjectArray2* TimeZoneNames_cs::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			$of(u"Sredn\u011bkolymsk"_s)
		}),
		$$new($ObjectArray, {
			$of("timezone.excity.Asia/Yekaterinburg"_s),
			$of(u"Jekat\u011brinburg"_s)
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			$of(u"Beulah, Severn\u00ed Dakota"_s)
		}),
		$$new($ObjectArray, {
			$of("timezone.excity.America/North_Dakota/Center"_s),
			$of(u"Center, Severn\u00ed Dakota"_s)
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			$of(u"New Salem, Severn\u00ed Dakota"_s)
		})
	}));
	return data;
}
...
$Class* TimeZoneNames_cs::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_cs, name, initialize, &_TimeZoneNames_cs_ClassInfo_, allocate$TimeZoneNames_cs);
	return class$;
}
