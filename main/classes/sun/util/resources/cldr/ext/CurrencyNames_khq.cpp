...
$MethodInfo _CurrencyNames_khq_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_khq::*)()>(&CurrencyNames_khq::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_khq_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_khq",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_khq_MethodInfo_
};

$Object* allocate$CurrencyNames_khq($Class* clazz) {
	return $of($alloc(CurrencyNames_khq));
}

void CurrencyNames_khq::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* CurrencyNames_khq::getContents() {
...
CurrencyNames_khq::CurrencyNames_khq() {
}

$Class* CurrencyNames_khq::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_khq, name, initialize, &_CurrencyNames_khq_ClassInfo_, allocate$CurrencyNames_khq);
	return class$;
}

$Class* CurrencyNames_khq::class$ = nullptr;
