...
$MethodInfo _TimeZoneNames_fur_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_fur::*)()>(&TimeZoneNames_fur::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_fur_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_fur",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_fur_MethodInfo_
};

$Object* allocate$TimeZoneNames_fur($Class* clazz) {
	return $of($alloc(TimeZoneNames_fur));
}
...
$Class* TimeZoneNames_fur::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_fur, name, initialize, &_TimeZoneNames_fur_ClassInfo_, allocate$TimeZoneNames_fur);
	return class$;
}
