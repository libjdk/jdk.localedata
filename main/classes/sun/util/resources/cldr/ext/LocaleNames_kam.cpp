...
$MethodInfo _LocaleNames_kam_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LocaleNames_kam::*)()>(&LocaleNames_kam::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _LocaleNames_kam_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.LocaleNames_kam",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_LocaleNames_kam_MethodInfo_
};

$Object* allocate$LocaleNames_kam($Class* clazz) {
	return $of($alloc(LocaleNames_kam));
}

void LocaleNames_kam::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* LocaleNames_kam::getContents() {
...
LocaleNames_kam::LocaleNames_kam() {
}

$Class* LocaleNames_kam::load$($String* name, bool initialize) {
	$loadClass(LocaleNames_kam, name, initialize, &_LocaleNames_kam_ClassInfo_, allocate$LocaleNames_kam);
	return class$;
}

$Class* LocaleNames_kam::class$ = nullptr;
