...
$MethodInfo _TimeZoneNames_pt_ST_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_pt_ST::*)()>(&TimeZoneNames_pt_ST::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_pt_ST_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_pt_ST",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_pt_ST_MethodInfo_
};

$Object* allocate$TimeZoneNames_pt_ST($Class* clazz) {
	return $of($alloc(TimeZoneNames_pt_ST));
}
...
$Class* TimeZoneNames_pt_ST::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_pt_ST, name, initialize, &_TimeZoneNames_pt_ST_ClassInfo_, allocate$TimeZoneNames_pt_ST);
	return class$;
}
