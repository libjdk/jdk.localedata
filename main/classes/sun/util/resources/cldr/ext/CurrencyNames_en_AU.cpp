...
$MethodInfo _CurrencyNames_en_AU_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_en_AU::*)()>(&CurrencyNames_en_AU::init$))},
...
$ObjectArray2* CurrencyNames_en_AU::getContents() {
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			$of("bam"_s),
			$of("Bosnia-Herzegovina Convertible Marka"_s)
		}),
		$$new($ObjectArray, {
			$of("bbd"_s),
