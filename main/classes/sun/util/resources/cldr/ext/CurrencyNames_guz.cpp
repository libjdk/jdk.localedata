...
$MethodInfo _CurrencyNames_guz_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_guz::*)()>(&CurrencyNames_guz::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_guz_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_guz",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_guz_MethodInfo_
};

$Object* allocate$CurrencyNames_guz($Class* clazz) {
	return $of($alloc(CurrencyNames_guz));
}

void CurrencyNames_guz::init$() {
...
CurrencyNames_guz::CurrencyNames_guz() {
}

$Class* CurrencyNames_guz::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_guz, name, initialize, &_CurrencyNames_guz_ClassInfo_, allocate$CurrencyNames_guz);
	return class$;
}

$Class* CurrencyNames_guz::class$ = nullptr;
