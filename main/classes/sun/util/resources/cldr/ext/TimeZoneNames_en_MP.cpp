...
$MethodInfo _TimeZoneNames_en_MP_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_en_MP::*)()>(&TimeZoneNames_en_MP::init$))},
...
TimeZoneNames_en_MP::TimeZoneNames_en_MP() {
}
...
$Class* TimeZoneNames_en_MP::class$ = nullptr;
