...
$MethodInfo _TimeZoneNames_ca_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_ca::*)()>(&TimeZoneNames_ca::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_ca_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_ca",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_ca_MethodInfo_
};

$Object* allocate$TimeZoneNames_ca($Class* clazz) {
	return $of($alloc(TimeZoneNames_ca));
}
...
$Class* TimeZoneNames_ca::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_ca, name, initialize, &_TimeZoneNames_ca_ClassInfo_, allocate$TimeZoneNames_ca);
	return class$;
}
