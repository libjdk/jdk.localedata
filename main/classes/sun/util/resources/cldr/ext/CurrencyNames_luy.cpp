...
$MethodInfo _CurrencyNames_luy_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_luy::*)()>(&CurrencyNames_luy::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_luy_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_luy",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_luy_MethodInfo_
};

$Object* allocate$CurrencyNames_luy($Class* clazz) {
	return $of($alloc(CurrencyNames_luy));
}

void CurrencyNames_luy::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* CurrencyNames_luy::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			$of("tzs"_s),
			$of("Sirinji ya Tanzania"_s)
		}),
		$$new($ObjectArray, {
			$of("ugx"_s),
			$of("Sirinji ya Uganda"_s)
		}),
		$$new($ObjectArray, {
			$of("usd"_s),
...
CurrencyNames_luy::CurrencyNames_luy() {
}

$Class* CurrencyNames_luy::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_luy, name, initialize, &_CurrencyNames_luy_ClassInfo_, allocate$CurrencyNames_luy);
	return class$;
}

$Class* CurrencyNames_luy::class$ = nullptr;
