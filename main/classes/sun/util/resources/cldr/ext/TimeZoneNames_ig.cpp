...
$MethodInfo _TimeZoneNames_ig_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_ig::*)()>(&TimeZoneNames_ig::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_ig_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_ig",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_ig_MethodInfo_
};

$Object* allocate$TimeZoneNames_ig($Class* clazz) {
	return $of($alloc(TimeZoneNames_ig));
}

void TimeZoneNames_ig::init$() {
...
$ObjectArray2* TimeZoneNames_ig::getContents() {
	...
	$var($StringArray, Atlantic, $new($StringArray, {
		"Oge Izugbe Mpaghara Atlantic"_s,
		""_s,
		"Oge Ihe Mpaghara Atlantic"_s,
		""_s,
		"Oge Mpaghara Atlantic"_s,
		""_s
	}));
	...
	$var($StringArray, Lord_Howe, $new($StringArray, {
		"Oge Izugbe Lord Howe"_s,
		""_s,
		"Oge Ihe Lord Howe"_s,
		""_s,
		"Oge Lord Howe"_s,
		""_s
	}));
	...
	$var($StringArray, New_Zealand, $new($StringArray, {
		"Oge Izugbe New Zealand"_s,
		""_s,
		"Oge Ihe New Zealand"_s,
		""_s,
		"Oge New Zealand"_s,
		""_s
	}));
	...
	$var($StringArray, Newfoundland, $new($StringArray, {
		"Oge Izugbe Newfoundland"_s,
		""_s,
		"Oge Ihe Newfoundland"_s,
		""_s,
		"Oge Newfoundland"_s,
		""_s
	}));
	...
	$var($StringArray, Mexico_Pacific, $new($StringArray, {
		"Oge Izugbe Mexican Pacific"_s,
		""_s,
		"Oge Ihe Mexican Pacific"_s,
		""_s,
		"Oge Mexican Pacific"_s,
		""_s
	}));
	...
	$var($StringArray, America_Central, $new($StringArray, {
		"Oge Izugbe Mpaghara Etiti"_s,
		""_s,
		"Oge Ihe Mpaghara Etiti"_s,
		""_s,
		"Oge Mpaghara Etiti"_s,
		""_s
	}));
	...
	$var($StringArray, America_Pacific, $new($StringArray, {
		"Oge Izugbe Mpaghara Pacific"_s,
		""_s,
		"Oge Ihe Mpaghara Pacific"_s,
		""_s,
		"Oge Mpaghara Pacific"_s,
		""_s
	}));
	$var($StringArray, French_Southern, $new($StringArray, {
		"Oge French Southern & Antarctic"_s,
		""_s,
		""_s,
		""_s,
		""_s,
	...
	$var($StringArray, Hawaii_Aleutian, $new($StringArray, {
		"Oge Izugbe Hawaii-Aleutian"_s,
		""_s,
		"Oge Ihe Hawaii-Aleutian"_s,
		""_s,
		"Oge Hawaii-Aleutian"_s,
		""_s
	}));
	$var($StringArray, Phoenix_Islands, $new($StringArray, {
		"Oge Phoenix Islands"_s,
		""_s,
		""_s,
		""_s,
		""_s,
	...
	$var($StringArray, Pierre_Miquelon, $new($StringArray, {
		"Oge Izugbe St. Pierre & Miquelon"_s,
		""_s,
		"Oge Ihe St. Pierre & Miquelon"_s,
		""_s,
		"Oge St. Pierre & Miquelon"_s,
		""_s
	}));
	$var($StringArray, America_Mountain, $new($StringArray, {
		"Oge Izugbe Mpaghara Ugwu"_s,
		""_s,
		"Oge Ihe Mpaghara Ugwu"_s,
		""_s,
		"Oge Mpaghara Ugwu"_s,
		""_s
	}));
	$var($StringArray, Marshall_Islands, $new($StringArray, {
		"Oge Marshall Islands"_s,
		""_s,
		""_s,
		""_s,
		""_s,
	...
	$var($StringArray, Mexico_Northwest, $new($StringArray, {
		"Oge Izugbe Northwest Mexico"_s,
		""_s,
		"Oge Ihe Northwest Mexico"_s,
		""_s,
		"Oge Northwest Mexico"_s,
		""_s
	}));
	$var($StringArray, Papua_New_Guinea, $new($StringArray, {
		"Oge Papua New Guinea"_s,
		""_s,
		""_s,
		""_s,
		""_s,
	...
	$var($StringArray, Australia_Central, $new($StringArray, {
		"Oge Izugbe Etiti Australia"_s,
		""_s,
		"Oge Ihe Etiti Australia"_s,
		""_s,
		"Oge Etiti Australia"_s,
		""_s
	}));
...
TimeZoneNames_ig::TimeZoneNames_ig() {
}

$Class* TimeZoneNames_ig::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_ig, name, initialize, &_TimeZoneNames_ig_ClassInfo_, allocate$TimeZoneNames_ig);
	return class$;
}

$Class* TimeZoneNames_ig::class$ = nullptr;
