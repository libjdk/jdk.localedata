...
$MethodInfo _TimeZoneNames_ast_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_ast::*)()>(&TimeZoneNames_ast::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_ast_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_ast",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_ast_MethodInfo_
};

$Object* allocate$TimeZoneNames_ast($Class* clazz) {
	return $of($alloc(TimeZoneNames_ast));
}
...
$ObjectArray2* TimeZoneNames_ast::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			$of(u"Puertu Pr\u00edncipe"_s)
		}),
		$$new($ObjectArray, {
			$of("timezone.excity.Atlantic/South_Georgia"_s),
			$of("Xeorxa del Sur"_s)
		}),
		$$new($ObjectArray, {
		...
		$$new($ObjectArray, {
			...
			$of("Nueva Salem, Dakota del Norte"_s)
		})
	}));
	return data;
}
...
$Class* TimeZoneNames_ast::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_ast, name, initialize, &_TimeZoneNames_ast_ClassInfo_, allocate$TimeZoneNames_ast);
	return class$;
}
