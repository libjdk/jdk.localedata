...
$MethodInfo _TimeZoneNames_mi_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_mi::*)()>(&TimeZoneNames_mi::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_mi_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_mi",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_mi_MethodInfo_
};

$Object* allocate$TimeZoneNames_mi($Class* clazz) {
	return $of($alloc(TimeZoneNames_mi));
}

void TimeZoneNames_mi::init$() {
...
TimeZoneNames_mi::TimeZoneNames_mi() {
}

$Class* TimeZoneNames_mi::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_mi, name, initialize, &_TimeZoneNames_mi_ClassInfo_, allocate$TimeZoneNames_mi);
	return class$;
}

$Class* TimeZoneNames_mi::class$ = nullptr;
