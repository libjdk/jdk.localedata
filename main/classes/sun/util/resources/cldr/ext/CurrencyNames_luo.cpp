...
$MethodInfo _CurrencyNames_luo_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_luo::*)()>(&CurrencyNames_luo::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_luo_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_luo",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_luo_MethodInfo_
};

$Object* allocate$CurrencyNames_luo($Class* clazz) {
	return $of($alloc(CurrencyNames_luo));
}

void CurrencyNames_luo::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* CurrencyNames_luo::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			$of("bwp"_s),
			$of("Pula mar Botswana"_s)
		}),
		$$new($ObjectArray, {
			$of("cad"_s),
			$of("Dola mar Kanada"_s)
		}),
		$$new($ObjectArray, {
			$of("cdf"_s),
		...
		$$new($ObjectArray, {
			$of("gbp"_s),
			$of("Pauni mar Uingereza"_s)
		}),
		$$new($ObjectArray, {
			$of("ghc"_s),
			$of("Sedi mar Ghana"_s)
		}),
		$$new($ObjectArray, {
			$of("gmd"_s),
...
CurrencyNames_luo::CurrencyNames_luo() {
}

$Class* CurrencyNames_luo::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_luo, name, initialize, &_CurrencyNames_luo_ClassInfo_, allocate$CurrencyNames_luo);
	return class$;
}

$Class* CurrencyNames_luo::class$ = nullptr;
