...
$MethodInfo _LocaleNames_teo_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LocaleNames_teo::*)()>(&LocaleNames_teo::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _LocaleNames_teo_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.LocaleNames_teo",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_LocaleNames_teo_MethodInfo_
};

$Object* allocate$LocaleNames_teo($Class* clazz) {
	return $of($alloc(LocaleNames_teo));
}

void LocaleNames_teo::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* LocaleNames_teo::getContents() {
...
LocaleNames_teo::LocaleNames_teo() {
}

$Class* LocaleNames_teo::load$($String* name, bool initialize) {
	$loadClass(LocaleNames_teo, name, initialize, &_LocaleNames_teo_ClassInfo_, allocate$LocaleNames_teo);
	return class$;
}

$Class* LocaleNames_teo::class$ = nullptr;
