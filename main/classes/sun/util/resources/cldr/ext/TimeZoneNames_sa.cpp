...
$MethodInfo _TimeZoneNames_sa_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_sa::*)()>(&TimeZoneNames_sa::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_sa_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_sa",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_sa_MethodInfo_
};

$Object* allocate$TimeZoneNames_sa($Class* clazz) {
	return $of($alloc(TimeZoneNames_sa));
}

void TimeZoneNames_sa::init$() {
...
TimeZoneNames_sa::TimeZoneNames_sa() {
}

$Class* TimeZoneNames_sa::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_sa, name, initialize, &_TimeZoneNames_sa_ClassInfo_, allocate$TimeZoneNames_sa);
	return class$;
}

$Class* TimeZoneNames_sa::class$ = nullptr;
