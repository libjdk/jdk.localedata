...
$MethodInfo _CurrencyNames_dje_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_dje::*)()>(&CurrencyNames_dje::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_dje_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_dje",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_dje_MethodInfo_
};

$Object* allocate$CurrencyNames_dje($Class* clazz) {
	return $of($alloc(CurrencyNames_dje));
}

void CurrencyNames_dje::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* CurrencyNames_dje::getContents() {
...
CurrencyNames_dje::CurrencyNames_dje() {
}

$Class* CurrencyNames_dje::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_dje, name, initialize, &_CurrencyNames_dje_ClassInfo_, allocate$CurrencyNames_dje);
	return class$;
}

$Class* CurrencyNames_dje::class$ = nullptr;
