...
$MethodInfo _CurrencyNames_cgg_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_cgg::*)()>(&CurrencyNames_cgg::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_cgg_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_cgg",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_cgg_MethodInfo_
};

$Object* allocate$CurrencyNames_cgg($Class* clazz) {
	return $of($alloc(CurrencyNames_cgg));
}

void CurrencyNames_cgg::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* CurrencyNames_cgg::getContents() {
...
CurrencyNames_cgg::CurrencyNames_cgg() {
}

$Class* CurrencyNames_cgg::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_cgg, name, initialize, &_CurrencyNames_cgg_ClassInfo_, allocate$CurrencyNames_cgg);
	return class$;
}

$Class* CurrencyNames_cgg::class$ = nullptr;
