...
$MethodInfo _CurrencyNames_zh_Hant_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_zh_Hant::*)()>(&CurrencyNames_zh_Hant::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_zh_Hant_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_zh_Hant",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_zh_Hant_MethodInfo_
};

$Object* allocate$CurrencyNames_zh_Hant($Class* clazz) {
	return $of($alloc(CurrencyNames_zh_Hant));
}

void CurrencyNames_zh_Hant::init$() {
...
CurrencyNames_zh_Hant::CurrencyNames_zh_Hant() {
}

$Class* CurrencyNames_zh_Hant::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_zh_Hant, name, initialize, &_CurrencyNames_zh_Hant_ClassInfo_, allocate$CurrencyNames_zh_Hant);
	return class$;
}

$Class* CurrencyNames_zh_Hant::class$ = nullptr;
