...
$MethodInfo _TimeZoneNames_se_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_se::*)()>(&TimeZoneNames_se::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_se_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_se",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_se_MethodInfo_
};

$Object* allocate$TimeZoneNames_se($Class* clazz) {
	return $of($alloc(TimeZoneNames_se));
}
...
$Class* TimeZoneNames_se::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_se, name, initialize, &_TimeZoneNames_se_ClassInfo_, allocate$TimeZoneNames_se);
	return class$;
}
