...
$MethodInfo _LocaleNames_rof_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LocaleNames_rof::*)()>(&LocaleNames_rof::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _LocaleNames_rof_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.LocaleNames_rof",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_LocaleNames_rof_MethodInfo_
};

$Object* allocate$LocaleNames_rof($Class* clazz) {
	return $of($alloc(LocaleNames_rof));
}

void LocaleNames_rof::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* LocaleNames_rof::getContents() {
...
LocaleNames_rof::LocaleNames_rof() {
}

$Class* LocaleNames_rof::load$($String* name, bool initialize) {
	$loadClass(LocaleNames_rof, name, initialize, &_LocaleNames_rof_ClassInfo_, allocate$LocaleNames_rof);
	return class$;
}

$Class* LocaleNames_rof::class$ = nullptr;
