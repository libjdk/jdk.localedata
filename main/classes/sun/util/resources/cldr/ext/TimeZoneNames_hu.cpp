...
$MethodInfo _TimeZoneNames_hu_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_hu::*)()>(&TimeZoneNames_hu::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_hu_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_hu",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_hu_MethodInfo_
};

$Object* allocate$TimeZoneNames_hu($Class* clazz) {
	return $of($alloc(TimeZoneNames_hu));
}

void TimeZoneNames_hu::init$() {
...
$ObjectArray2* TimeZoneNames_hu::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			$of("Szrednekolimszk"_s)
		}),
		$$new($ObjectArray, {
			$of("timezone.excity.Asia/Yekaterinburg"_s),
			$of("Jekatyerinburg"_s)
		}),
		$$new($ObjectArray, {
...
TimeZoneNames_hu::TimeZoneNames_hu() {
}

$Class* TimeZoneNames_hu::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_hu, name, initialize, &_TimeZoneNames_hu_ClassInfo_, allocate$TimeZoneNames_hu);
	return class$;
}

$Class* TimeZoneNames_hu::class$ = nullptr;
