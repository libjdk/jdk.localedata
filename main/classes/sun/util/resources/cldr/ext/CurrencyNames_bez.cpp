...
$MethodInfo _CurrencyNames_bez_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_bez::*)()>(&CurrencyNames_bez::init$))},
...
CurrencyNames_bez::CurrencyNames_bez() {
}
...
$Class* CurrencyNames_bez::class$ = nullptr;
