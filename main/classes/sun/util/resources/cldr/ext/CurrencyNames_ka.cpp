...
$MethodInfo _CurrencyNames_ka_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CurrencyNames_ka::*)()>(&CurrencyNames_ka::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _CurrencyNames_ka_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.CurrencyNames_ka",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_CurrencyNames_ka_MethodInfo_
};

$Object* allocate$CurrencyNames_ka($Class* clazz) {
	return $of($alloc(CurrencyNames_ka));
}

void CurrencyNames_ka::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* CurrencyNames_ka::getContents() {
...
CurrencyNames_ka::CurrencyNames_ka() {
}

$Class* CurrencyNames_ka::load$($String* name, bool initialize) {
	$loadClass(CurrencyNames_ka, name, initialize, &_CurrencyNames_ka_ClassInfo_, allocate$CurrencyNames_ka);
	return class$;
}

$Class* CurrencyNames_ka::class$ = nullptr;
