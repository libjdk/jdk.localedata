...
$MethodInfo _LocaleNames_jmc_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LocaleNames_jmc::*)()>(&LocaleNames_jmc::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _LocaleNames_jmc_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.LocaleNames_jmc",
	"sun.util.resources.OpenListResourceBundle",
	nullptr,
	nullptr,
	_LocaleNames_jmc_MethodInfo_
};

$Object* allocate$LocaleNames_jmc($Class* clazz) {
	return $of($alloc(LocaleNames_jmc));
}

void LocaleNames_jmc::init$() {
	$OpenListResourceBundle::init$();
}

$ObjectArray2* LocaleNames_jmc::getContents() {
...
LocaleNames_jmc::LocaleNames_jmc() {
}

$Class* LocaleNames_jmc::load$($String* name, bool initialize) {
	$loadClass(LocaleNames_jmc, name, initialize, &_LocaleNames_jmc_ClassInfo_, allocate$LocaleNames_jmc);
	return class$;
}

$Class* LocaleNames_jmc::class$ = nullptr;
