...
$MethodInfo _TimeZoneNames_en_AE_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TimeZoneNames_en_AE::*)()>(&TimeZoneNames_en_AE::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _TimeZoneNames_en_AE_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.util.resources.cldr.ext.TimeZoneNames_en_AE",
	"sun.util.resources.TimeZoneNamesBundle",
	nullptr,
	nullptr,
	_TimeZoneNames_en_AE_MethodInfo_
};

$Object* allocate$TimeZoneNames_en_AE($Class* clazz) {
	return $of($alloc(TimeZoneNames_en_AE));
}
...
$Class* TimeZoneNames_en_AE::load$($String* name, bool initialize) {
	$loadClass(TimeZoneNames_en_AE, name, initialize, &_TimeZoneNames_en_AE_ClassInfo_, allocate$TimeZoneNames_en_AE);
	return class$;
}
