...
$MethodInfo _LocaleNames_ms_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LocaleNames_ms::*)()>(&LocaleNames_ms::init$))},
