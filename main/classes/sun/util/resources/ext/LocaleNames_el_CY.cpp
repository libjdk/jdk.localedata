...
$MethodInfo _LocaleNames_el_CY_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LocaleNames_el_CY::*)()>(&LocaleNames_el_CY::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _LocaleNames_el_CY_ClassInfo_ = {
	$PUBLIC | $FINAL | $ACC_SUPER,
	"sun.util.resources.ext.LocaleNames_el_CY",
	"sun.util.resources.LocaleNamesBundle",
	nullptr,
	nullptr,
	_LocaleNames_el_CY_MethodInfo_
};

$Object* allocate$LocaleNames_el_CY($Class* clazz) {
	return $of($alloc(LocaleNames_el_CY));
}

void LocaleNames_el_CY::init$() {
...
LocaleNames_el_CY::LocaleNames_el_CY() {
}

$Class* LocaleNames_el_CY::load$($String* name, bool initialize) {
	$loadClass(LocaleNames_el_CY, name, initialize, &_LocaleNames_el_CY_ClassInfo_, allocate$LocaleNames_el_CY);
	return class$;
}

$Class* LocaleNames_el_CY::class$ = nullptr;
