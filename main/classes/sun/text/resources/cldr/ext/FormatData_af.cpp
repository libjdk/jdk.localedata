...
$MethodInfo _FormatData_af_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(FormatData_af::*)()>(&FormatData_af::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _FormatData_af_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.text.resources.cldr.ext.FormatData_af",
	"java.util.ListResourceBundle",
	nullptr,
	nullptr,
	_FormatData_af_MethodInfo_
};

$Object* allocate$FormatData_af($Class* clazz) {
	return $of($alloc(FormatData_af));
}
...
$ObjectArray2* FormatData_af::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			$of("midnight:00:00;night1:00:00-05:00;afternoon1:12:00-18:00;morning1:05:00-12:00;evening1:18:00-24:00"_s)
		}),
		$$new($ObjectArray, {
...
$Class* FormatData_af::load$($String* name, bool initialize) {
	$loadClass(FormatData_af, name, initialize, &_FormatData_af_ClassInfo_, allocate$FormatData_af);
	return class$;
}
