...
$MethodInfo _FormatData_luy_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(FormatData_luy::*)()>(&FormatData_luy::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _FormatData_luy_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.text.resources.cldr.ext.FormatData_luy",
	"java.util.ListResourceBundle",
	nullptr,
	nullptr,
	_FormatData_luy_MethodInfo_
};

$Object* allocate$FormatData_luy($Class* clazz) {
	return $of($alloc(FormatData_luy));
}
...
$Class* FormatData_luy::load$($String* name, bool initialize) {
	$loadClass(FormatData_luy, name, initialize, &_FormatData_luy_ClassInfo_, allocate$FormatData_luy);
	return class$;
}
