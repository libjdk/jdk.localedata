...
$MethodInfo _FormatData_ii_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(FormatData_ii::*)()>(&FormatData_ii::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _FormatData_ii_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.text.resources.cldr.ext.FormatData_ii",
	"java.util.ListResourceBundle",
	nullptr,
	nullptr,
	_FormatData_ii_MethodInfo_
};

$Object* allocate$FormatData_ii($Class* clazz) {
	return $of($alloc(FormatData_ii));
}
...
$Class* FormatData_ii::load$($String* name, bool initialize) {
	$loadClass(FormatData_ii, name, initialize, &_FormatData_ii_ClassInfo_, allocate$FormatData_ii);
	return class$;
}
