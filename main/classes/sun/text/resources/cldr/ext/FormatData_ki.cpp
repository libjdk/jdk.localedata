...
$MethodInfo _FormatData_ki_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(FormatData_ki::*)()>(&FormatData_ki::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _FormatData_ki_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.text.resources.cldr.ext.FormatData_ki",
	"java.util.ListResourceBundle",
	nullptr,
	nullptr,
	_FormatData_ki_MethodInfo_
};

$Object* allocate$FormatData_ki($Class* clazz) {
	return $of($alloc(FormatData_ki));
}
...
$Class* FormatData_ki::load$($String* name, bool initialize) {
	$loadClass(FormatData_ki, name, initialize, &_FormatData_ki_ClassInfo_, allocate$FormatData_ki);
	return class$;
}
