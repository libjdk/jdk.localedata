...
$MethodInfo _FormatData_fy_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(FormatData_fy::*)()>(&FormatData_fy::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _FormatData_fy_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.text.resources.cldr.ext.FormatData_fy",
	"java.util.ListResourceBundle",
	nullptr,
	nullptr,
	_FormatData_fy_MethodInfo_
};

$Object* allocate$FormatData_fy($Class* clazz) {
	return $of($alloc(FormatData_fy));
}
...
$Class* FormatData_fy::load$($String* name, bool initialize) {
	$loadClass(FormatData_fy, name, initialize, &_FormatData_fy_ClassInfo_, allocate$FormatData_fy);
	return class$;
}
