...
$MethodInfo _FormatData_nmg_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(FormatData_nmg::*)()>(&FormatData_nmg::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _FormatData_nmg_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.text.resources.cldr.ext.FormatData_nmg",
	"java.util.ListResourceBundle",
	nullptr,
	nullptr,
	_FormatData_nmg_MethodInfo_
};

$Object* allocate$FormatData_nmg($Class* clazz) {
	return $of($alloc(FormatData_nmg));
}
...
$Class* FormatData_nmg::load$($String* name, bool initialize) {
	$loadClass(FormatData_nmg, name, initialize, &_FormatData_nmg_ClassInfo_, allocate$FormatData_nmg);
	return class$;
}
