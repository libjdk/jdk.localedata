...
$MethodInfo _FormatData_naq_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(FormatData_naq::*)()>(&FormatData_naq::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _FormatData_naq_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.text.resources.cldr.ext.FormatData_naq",
	"java.util.ListResourceBundle",
	nullptr,
	nullptr,
	_FormatData_naq_MethodInfo_
};

$Object* allocate$FormatData_naq($Class* clazz) {
	return $of($alloc(FormatData_naq));
}
...
$ObjectArray2* FormatData_naq::getContents() {
	...
	$var($ObjectArray2, data, $new($ObjectArray2, {
		...
		$$new($ObjectArray, {
			...
			$of(metaValue_standalone_MonthAbbreviations)
		}),
		$$new($ObjectArray, {
...
$Class* FormatData_naq::load$($String* name, bool initialize) {
	$loadClass(FormatData_naq, name, initialize, &_FormatData_naq_ClassInfo_, allocate$FormatData_naq);
	return class$;
}
