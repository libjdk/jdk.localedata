...
$MethodInfo _FormatData_saq_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(FormatData_saq::*)()>(&FormatData_saq::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _FormatData_saq_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.text.resources.cldr.ext.FormatData_saq",
	"java.util.ListResourceBundle",
	nullptr,
	nullptr,
	_FormatData_saq_MethodInfo_
};

$Object* allocate$FormatData_saq($Class* clazz) {
	return $of($alloc(FormatData_saq));
}
...
$Class* FormatData_saq::load$($String* name, bool initialize) {
	$loadClass(FormatData_saq, name, initialize, &_FormatData_saq_ClassInfo_, allocate$FormatData_saq);
	return class$;
}
