...
$MethodInfo _FormatData_rm_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(FormatData_rm::*)()>(&FormatData_rm::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _FormatData_rm_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.text.resources.cldr.ext.FormatData_rm",
	"java.util.ListResourceBundle",
	nullptr,
	nullptr,
	_FormatData_rm_MethodInfo_
};

$Object* allocate$FormatData_rm($Class* clazz) {
	return $of($alloc(FormatData_rm));
}
...
$Class* FormatData_rm::load$($String* name, bool initialize) {
	$loadClass(FormatData_rm, name, initialize, &_FormatData_rm_ClassInfo_, allocate$FormatData_rm);
	return class$;
}
