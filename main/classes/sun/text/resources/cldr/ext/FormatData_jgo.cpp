...
$MethodInfo _FormatData_jgo_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(FormatData_jgo::*)()>(&FormatData_jgo::init$))},
	{"getContents", "()[[Ljava/lang/Object;", nullptr, $PROTECTED | $FINAL},
	{}
};

$ClassInfo _FormatData_jgo_ClassInfo_ = {
	$PUBLIC | $ACC_SUPER,
	"sun.text.resources.cldr.ext.FormatData_jgo",
	"java.util.ListResourceBundle",
	nullptr,
	nullptr,
	_FormatData_jgo_MethodInfo_
};

$Object* allocate$FormatData_jgo($Class* clazz) {
	return $of($alloc(FormatData_jgo));
}
...
$Class* FormatData_jgo::load$($String* name, bool initialize) {
	$loadClass(FormatData_jgo, name, initialize, &_FormatData_jgo_ClassInfo_, allocate$FormatData_jgo);
	return class$;
}
